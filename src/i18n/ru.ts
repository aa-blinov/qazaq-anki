...
export const ru: Translations = {
  ...
  'stats.resetDialog.cardsLabel': 'Затронет карточек',
  'stats.resetDialog.cardOne': 'карточка',
  'stats.resetDialog.cardFew': 'карточки',
  'stats.resetDialog.cardMany': 'карточек',
  'stats.resetDialog.reviewsLabel': 'Повторений пропадёт',
  'stats.resetDialog.reviewOne': 'повторение',
  'stats.resetDialog.reviewFew': 'повторения',
  'stats.resetDialog.reviewMany': 'повторений',
  'stats.resetDialog.confirm': 'Да, сбросить',
  'stats.resetDialog.cancel': 'Отмена',
  'confirmDialog.closeAria': 'Закрыть',
